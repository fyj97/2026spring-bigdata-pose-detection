...
Image mode (each record's "source" is an image path):
  python visualize_yolo_annotations.py --annotations out\\annotations.jsonl --output_dir out\\viz2

Video mode:
  python visualize_yolo_annotations.py --annotations out\\annotations.jsonl --video clip.mp4 --output_dir out\\viz2
"""
